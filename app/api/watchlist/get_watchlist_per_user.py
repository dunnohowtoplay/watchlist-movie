...
def get_watchlist_per_user(request:Request, user_id: int):
    redis_key = f"watchlist-list-per-user:{user_id}"
    ...
    with Session(db_engine) as session:
        ...
        list_watchlist = watchlist_class.list_watchlist_per_user(user_id=user_id)
